...
# ----------------------------
# UpBlock com CBAM aplicado **nos skips antes da concat**
# ----------------------------
...
# ----------------------------
# Dual Encoder UNet 4 níveis com CBAM nos skips
# ----------------------------
class DualEncoderUNetSkip4_CBAM_Skips(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=32, use_cbam=True):
        super().__init__()
        self.use_cbam = use_cbam
    ...
    def forward(self, part1, part2):
        ...
        # Decoder com skips aplicando CBAM nos skips
        ...
        # <-- Retorna uma tupla para manter compatibilidade com train_loop
        return out, None
...
if __name__ == "__main__":
    model = DualEncoderUNetSkip4_CBAM_Skips(input_nc=3, output_nc=3, ngf=32, use_cbam=True)
