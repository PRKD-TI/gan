# File: T004_CBAM_Decoder.py
import torch
import torch.nn as nn
from .generator_blocks import ConvBlock, UpBlockCBAMDecoder
...
class Generator(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=64):
        ...
        # Use UpBlockCBAMDecoder
        self.dec4 = UpBlockCBAMDecoder(ngf*16, ngf*8*2, ngf*8, ConvBlock)
        self.dec3 = UpBlockCBAMDecoder(ngf*8,  ngf*4*2, ngf*4, ConvBlock)
        self.dec2 = UpBlockCBAMDecoder(ngf*4,  ngf*2*2, ngf*2, ConvBlock)
        self.dec1 = UpBlockCBAMDecoder(ngf*2,  ngf*1*2, ngf,   ConvBlock)
