# File: T007_SelfAttn_Bottleneck.py
import torch
import torch.nn as nn
from .generator_blocks import ConvBlock, UpBlockBaseline, NonLocalBlock
...
class Generator(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=64):
        ...
        # Usa ConvBlock + NonLocalBlock no Bottleneck
        self.bottleneck_conv = ConvBlock(ngf*8*2, ngf*16)
