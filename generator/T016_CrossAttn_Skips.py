# File: T016_CrossAttn_Skips.py
import torch
import torch.nn as nn
from .generator_blocks import ConvBlock, UpBlockCrossAttentionSkip
...
class Generator(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=64):
        ...
        # Use UpBlockCrossAttentionSkip
        self.dec4 = UpBlockCrossAttentionSkip(ngf*16, ngf*8*2, ngf*8, ConvBlock)
        self.dec3 = UpBlockCrossAttentionSkip(ngf*8,  ngf*4*2, ngf*4, ConvBlock)
        self.dec2 = UpBlockCrossAttentionSkip(ngf*4,  ngf*2*2, ngf*2, ConvBlock)
        self.dec1 = UpBlockCrossAttentionSkip(ngf*2,  ngf*1*2, ngf,   ConvBlock)
    ...
    def forward(self, part1, part2):
        ...
        # O UpBlockCrossAttentionSkip vai lidar com a separação dos tensores concatenados
