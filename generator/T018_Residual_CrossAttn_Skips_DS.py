# File: T018_Residual_CrossAttn_Skips_DS.py
import torch
import torch.nn as nn
from .generator_blocks import ResidualBlock, UpBlockCrossAttentionSkip
...
class Generator(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=64):
        ...
        self.bottleneck = ResidualBlock(ngf*8*2, ngf*16)
        
        # Use UpBlockCrossAttentionSkip com ResidualBlock
        self.dec4 = UpBlockCrossAttentionSkip(ngf*16, ngf*8*2, ngf*8, ResidualBlock)
        self.dec3 = UpBlockCrossAttentionSkip(ngf*8,  ngf*4*2, ngf*4, ResidualBlock)
        self.dec2 = UpBlockCrossAttentionSkip(ngf*4,  ngf*2*2, ngf*2, ResidualBlock)
        self.dec1 = UpBlockCrossAttentionSkip(ngf*2,  ngf*1*2, ngf,   ResidualBlock)
