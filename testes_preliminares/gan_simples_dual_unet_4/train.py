...
from generator_preliminares.gen_dual_unet_1 import DualEncoderUNet as default_generator  # <<< UNet com entrada separada
...
def main():
    ...
    dataset_name = "192x128_small_4000"                   # Vai definir nome das pastas também
