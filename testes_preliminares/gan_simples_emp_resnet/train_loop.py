...
def train(
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, ((part1, part2), target) in pbar:
            ...
            # Train Discriminator com label smoothing (sem ruído)
            ...
            # Gensteps fixo por enquanto
            if gen_steps_mode == 'fixed':
                gen_steps = max_gen_steps
            else:
                gen_steps = max_gen_steps  # futuramente implementar dinâmico
