...
from generator_preliminares.gen_dual_unet_deep8 import DualEncoderUNetDeep as default_generator
...
def main():
    ...
    dataset_name = "384x256_small_4000"                   # Vai definir nome das pastas também
